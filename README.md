<div class="resume">
  <div class="base">
    <div class="profile">
      ...
      <div class="info">
        <h1 class="name">Rakesh</h1>
        <h2 class="job">Frontend Web Designer UXUI Designer</h2>
      </div>
    </div>
    <div class="about">
  ...
  <div class="func">
    <div class="work">
      ...
      <ul>
        <li><span>Technical Consultant -<br>Web Design</span><small>Born Designers</small><small>2022 Mar - Now</small></li>
    ...
    <div class="edu">
      ...
      <ul>
        <li><span>Btech it<br>Web Design and Development</span><small></li>
        <li><span>Informaton Technology</span><small>KEC</small></li>
